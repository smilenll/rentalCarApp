...
export class V2DB1586875437729 implements MigrationInterface {
    name = 'V2DB1586875437729'

    public async up(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query(`ALTER TABLE "cars" DROP CONSTRAINT "FK_0d84b16e0ac645021378dfb170e"`, undefined);
        await queryRunner.query(`CREATE TABLE "amortizations" ("id" SERIAL NOT NULL, "name" character varying(50) NOT NULL, "from" integer NOT NULL DEFAULT 0, "to" integer NOT NULL DEFAULT 0, "isDeleted" boolean NOT NULL DEFAULT false, CONSTRAINT "UQ_45e68eb2bd89a0cd80859c05a7b" UNIQUE ("name"), CONSTRAINT "PK_d58cd112eb3ea59d6f8fe366ff9" PRIMARY KEY ("id"))`, undefined);
        await queryRunner.query(`CREATE TABLE "manufacturers" ("id" SERIAL NOT NULL, "name" character varying(50) NOT NULL, "isDeleted" boolean NOT NULL DEFAULT false, CONSTRAINT "UQ_379a6015606c983f18c0b03e9e2" UNIQUE ("name"), CONSTRAINT "PK_138520de32c379a48e703441975" PRIMARY KEY ("id"))`, undefined);
        await queryRunner.query(`CREATE TABLE "models" ("id" SERIAL NOT NULL, "name" character varying(50) NOT NULL, "isDeleted" boolean NOT NULL DEFAULT false, "carClassId" integer, "manufactureId" integer, CONSTRAINT "UQ_3492c71396207453cf17c0928fb" UNIQUE ("name"), CONSTRAINT "PK_ef9ed7160ea69013636466bf2d5" PRIMARY KEY ("id"))`, undefined);
